...
// logged-in web-session client. An unrecognized provider throws — background.js
// catches it and surfaces the message to the content side via MSG_ERROR, which
// is strictly better than silently asking Gemini about another site's page.
