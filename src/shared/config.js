...
GA.config = {
  ...
  PANEL_OUTLINE_CHARS: 80, // Outline row: first N chars of the prompt — a landmark, not the prompt
  ...
  STREAM_RENDER_MAX_MS: 70, // longer answers batch renders to one per this window
